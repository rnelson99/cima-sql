...
SELECT        EntityID, Prefix, FirstName, MiddleName, LastName, Suffix, EntityType, AddDate, AddID, ChangeDate, ChangeID, Salt, WebPwd, MobileApp, AccountExpiration, PasswordExpiration, PasswordCycle, Status, PassAttempts, 
                         ...
                         Chalkboard, legalFirst, nameNoSpecial, merged, SyncModificationDate, EntityGUID, CimaPwd
FROM            Contacts.Entity_TBL
WHERE        (ISNULL(merged, 0) = 0)
GO
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "Entity_TBL (Contacts)"
            Begin Extent = 
               Top = 0
               Left = 38
               Bottom = 285
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'Contacts', @level1type=N'VIEW',@level1name=N'Entity'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'Contacts', @level1type=N'VIEW',@level1name=N'Entity'
GO