...
*/
create  PROCEDURE [dbo].[SalesTaxDetermination]
	@projectid int = 0,
	@addid int = 0
...
BEGIN
	...
	*/
	...
	if @question = 1 set @group1Category = @answer
		...
		if @question = 3 set @group3ContractType = @answer
		if @question = 4 set @group4Separated = @answer
239	Non-residential	ProjectTaxCategory	2
241	Addition	ProjectTaxType	4
248	Lump Sum	ProjectTaxContract	1
*/

	if @group1Category = 2 and @group2ProjectType = 4 and @group3ContractType = 1
	begin
		set @ConsumableP = 1
		set @MaterialsP = 1
		set @OutofstateMaterialP = 1
		...
		set @ConsumableS = 0
		set @MaterialsS = 0
		set @OutofstateMaterialS = 0
		set @RealPropServicesS = 0
		set @RentalEquipmentS = 0
	end	
